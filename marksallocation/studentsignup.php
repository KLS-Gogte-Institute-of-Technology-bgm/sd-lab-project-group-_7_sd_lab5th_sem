...
<div class="container ">
      ...
      <div class="img form-group text-center">
        ...
        <b> <label for="user" class="col-lg-9 col-md-9 col-sm-9 col-xl-9 m-auto d-block text-white">ROLL NUMBER:</label></b>
            <input type="number" name="usn" id="user" class="col-lg-9 col-md-9 col-sm-9 col-xl-96 m-auto d-block form-control"  placeholder="Enter Your ROLL NUMBER" required>
        </div>

        <div class="form-group">
        <b> <label for="user" class="col-lg-9 col-md-9 col-sm-9 col-xl-9 m-auto d-block text-white">PHONE NUMBER:</label></b>
            <input type="number" name="phno" id="phno" class="col-lg-9 col-md-9 col-sm-9 col-xl-9 m-auto d-block form-control" min="1000000000" max="9999999999" placeholder="Enter Your phone number" required>
        </div>
    ...
    <input type="submit" name="submit_st" value="SIGNUP" class="btn btn-success form-control col-lg-9 col-md-9 col-sm-9 col-xl-9 m-auto d-block"><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <a href="studentlogin.php" class="text-white text-center col-lg-4 m-auto ">login ..??</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    ...
                    { 
                      $destinationfile ='image/'.$filename;
                                 ...
                                 /*create table student
                                  ...
                                  $q="INSERT INTO `student`(`rollno`, `name`, `phno`, `pass`, `path`) VALUES ($usn,'$name',$phno,'$pass1','$destinationfile')";
