...
<div class="container ">
      ...
      <div class="img form-group text-center">
        ...
        <b> <label for="user" class="col-lg-9 col-md-9 col-sm-9 col-xl-9 m-auto d-block text-white">PHONE NUMBER:</label></b>
            <input type="text" name="phno" id="phno" class="col-lg-9 col-md-9 col-sm-9 col-xl-9 m-auto d-block form-control" min="1000000000" max="9999999999"  placeholder="Enter Your phone number" required>
        </div>
